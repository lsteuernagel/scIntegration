...
filepath_sets = parameter_dict["filepath_sets"]
results_path = parameter_dict["results_path"]
...
## settings --> forgot to set... but defaults to 0 so shoould still be stable across runs!!
scvi.settings.seed = 0#global_seed
...
# read feature set into dictionary of numpy character arrays
...
# setup for scvi
scvi.data.setup_anndata(adata_scvi, batch_key=batch_var, categorical_covariate_keys=categorical_covariates,continuous_covariate_keys=continuous_covariates)

...
# load hypomap v1
#hypoMap_seurat_v1 = readRDS("/beegfs/scratch/bruening_scratch/lsteuernagel/data/hypoMap/hypoMap_largeFiles/hypothalamus_neurons_map.rds")
...
hypoMap_seurat_v1_metadata = hypoMap_seurat_v1@meta.data
hypoMap_seurat_v2_metadata = hypoMap_seurat@meta.data
hypoMap_seurat_v1_metadata$Barcode = stringr::str_extract(hypoMap_seurat_v1_metadata$Cell_ID,pattern = "[ACGTN]{5,}") # \\-?[0-9]?
...
hypoMap_seurat_v1_metadata$pasted_barcode = paste0(hypoMap_seurat_v1_metadata$Dataset,"_",hypoMap_seurat_v1_metadata$Barcode)
...
# join
joined_metadata = dplyr::left_join(hypoMap_seurat_v1_metadata %>% dplyr::select(pasted_barcode,Cell_ID,K169_pruned,Dataset) ,
